...
# (229x229x1 images) as well as provides with best accuracy results:
...
class Network_v2(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc1 = nn.Linear(114*114*32 , OUTPUT_FEATURES) 
...
# Instantiate a neural network model from the selected class (file CNN-Models.py)
model = Network_v2()
print("\n***********************************************\n\n",
      "CCN STRUCTURE:\n\n",  
      model,
