...
Inputs::
    ...
    1. Images taken during the drones fly-by over the PoC area, which are 
       already converted to FLIR -> /usr/PoC/in/

    2. Trained CNN Model .pth file -> /usr/PoC/CNN/trained-model.pth

Output::

    1. Classification results -> /usr/PoC/out/
...
IN_DIR = BASE_FOLDER +"/flir_buffer"
